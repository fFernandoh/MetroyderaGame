...
public class Entity {
	...
	//public static BufferedImage ENEMY_BOSS01 = Game.spritesheet.getSprite(7*16, 32, 16, 16);
	//public static BufferedImage ENEMY_BOSS01_FEEDBACK = Game.spritesheet.getSprite(9*16, 32, 16, 16);
